...
do
    python -m nmp.test_run --cpu $ENV_NAME --exp-names $LOG_DIR/params.pkl --exp-names $LOG_DIR/params.pkl --seed $SEED --horizon $HORIZON --episodes 0 --solver_type $SOLVER_TYPE # >> $FILENAME
done
done