...
do
    python -m nmp.test_run --cpu --render --obstacles_type boxes --exp-name $LOG_DIR/itr_900.pkl --seed $SEED --horizon $HORIZON --solver_type $SOLVER_TYPE $ENV_NAME >> $FILENAME
done
done
