...
LOG_DIR=/home/yixuan/sshape_boxes_global_bound/seed0
# LOG_DIR=log_dir
SOLVER_TYPE=RL
# ENV_NAME=SShape-Boxes-64Pts-Rays-v0
ENV_NAME=SShape-Boxes-256Pts-SurfaceNormals-v0
...
for HORIZON in 80
do
FILENAME=test_output/time_test/$(whoami)_$(date +%y_%m_%d_%H_%M_%S)_horizon_${HORIZON}_solver_${SOLVER_TYPE}_env_${ENV_NAME}_cpu_True
touch $FILENAME
for SEED in {0..1000}
