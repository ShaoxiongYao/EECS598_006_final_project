...
do
    python -m nmp.test_run --cpu --render --obstacles_type boxes --exp-names itr_900.pkl,itr_920.pkl,itr_940.pkl,itr_960.pkl,itr_980.pkl --seed $SEED --horizon $HORIZON --solver_type $SOLVER_TYPE $ENV_NAME >> $FILENAME
done
done
