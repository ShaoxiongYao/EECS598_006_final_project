...
do
    python -m nmp.test_run --cpu --obstacles_type handcraft:hardest -max_iters 500000 --exp-names $EXP_NAMES --seed $SEED --horizon $HORIZON --solver_type $SOLVER_TYPE $ENV_NAME >> $FILENAME
done
done
